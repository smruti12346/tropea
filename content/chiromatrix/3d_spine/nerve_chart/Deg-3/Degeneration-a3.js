...
lib.ssMetadata = [
		{name:"Degeneration_a3_atlas_", frames: [[0,0,220,396],[222,0,220,396]]}
];
...
(lib.Bitmap26 = function() {
	this.spriteSheet = ss["Degeneration_a3_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.Degenerationa3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Degeneration_a3_atlas_.png", id:"Degeneration_a3_atlas_"}
	],
	preloads: []
};
