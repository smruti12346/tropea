...
=======
import './home.css';
>>>>>>> 679ac64dbbfea46c095ac28ff8bff504895be6a7
const Home = () => {
  return (
    <>
      <Helmet>
        ...
        <div className="container trust">
          <div className="row">
            <div className="col-md-6">
              <h1 className="title1">Your Trusted Chiropractic Treatment Near Me</h1>
              ...
              <div className="who-are-we">
                ...
                <p>Dr. Tropea, the best chiropractic doctor near me, offers noninvasive, natural pain relief without the use of medicines or the risks associated with intrusive treatments. He appreciates building one-on-one connections with his patients and strives to satisfy each individual's requirements and health objectives.</p>
                <p>At Tropea Chiropractic Inc., chiropractic doctors near me provide a complete in-house rehabilitation facility allowing patients to benefit from all aspects of their treatment plan under one roof. Bemer mat therapy, electrical muscle stimulation, cold laser, and Proprioceptive Neuromuscular Facilitation (PNF) are among the chiropractic treatments available near me to enhance circulation, ease muscle spasms and trigger points, and reduce pain.</p>
              </div>
            ...
            <div className="col-md-6">
              <div className="right-content">
                <h2 className="subtitle">Why Choose Us For the Best Chiropractic Near Me?</h2>
                <ul>
                ...
                <h2 className="subtitle">Revitalize Your Spine, Revitalize Your Life!</h2>
                <p>Discover how chiropractic care may change your life. Get the potential benefits of a properly positioned spine, such as increased mobility, less discomfort, and improved overall wellbeing.</p>
                <p>Boost your energy levels and maximize your performance with chiropractic doctors near me. Through chiropractic adjustments, nutritional advice, and lifestyle recommendations, we'll help you unlock your full potential.</p>
                <p>Also, avail emergency chiropractic near me at Tropea Chiropractic.</p>
                <h2 className="subtitle">Discover the Tropea Chiropractic Advantage</h2>
                <ul>
                  <li>Cutting-edge techniques for effective pain management</li>
                  ...
                  <li>Convenient location and flexible appointment options</li>   
                </ul>
                <p className="bold">Choose us as your best chiropractic near me. </p>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="faqs">
                <h2 className="title3">FAQs About Chiropractic Treatment Near Me</h2>
                <ol className="faq">
                  <li>Is chiropractic treatment safe?</li>
                  <p>Chiropractic treatment is considered to be safe and noninvasive. The chiropractic clinic near me employs gentle techniques to ensure comfort and safety throughout treatment.</p>
                  <li>How many chiropractic sessions will I need to recover?</li>
                  <p>The number of sessions required will depend on your specific condition, symptoms' severity and your response to a particular therapy. Chiropractic doctor near me will evaluate your progress regularly and create the treatment plan as needed.</p>
                  <li>Can chiropractic care help with back pain?</li>
                  <p>Treatments like spinal adjustments can help relieve pain, restore spinal alignment and improve general back health to a great extent. </p>
                  <li>Should I go for chiropractic treatment after a car accident?</li>
                  <p>Absolutely! It helps people who have suffered injuries or trauma in car accidents.  Chiropractic doctor near me has expertise in treating car accident-related injuries like whiplash and can help you recover and regain mobility</p>
                  <li>Is chiropractic treatment effective for sports injuries?</li>
                  <p>Yes, chiropractic treatment near me can play a crucial role in recovering and managing sports injuries. Our chiropractic doctors near me have specialized knowledge and techniques to address sports-related injuries and help athletes return to peak performance.</p>
                </ol>
              </div>
            </div>
          </div>
          <div className="row">
      <div className="col-md-12">
        <h2 className="subtitle">Experience Natural Pain Relief Today</h2>
        <p>Tropea chiropractor is ready to help if you're seeking for an efficient chiropractic near me walk-in. Visit or call us right now to get the best chiropractic therapy in the area.</p>
      </div>
    </div>
    <div className="row">
      <div className="col-md-12">
        ...
        <form>
          <div className="form-group">
            ...
            <input type="text" id="full-name" className="form-control" placeholder="Full Name" />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <input type="text" id="preferred-appointment" className="form-control" placeholder="Preferred Appointment" />
          </div>
